...
using Docs.Compiler.Core.IO.Globbing;
using Docs.Compiler.Core.IO.Globbing.Nodes;
using Docs.Compiler.Core.IO.Globbing.Nodes.Roots;
...
namespace Docs.Compiler.Core.IO
{
    ...
    /// </summary>
    internal sealed class Globber : IGlobber
    {
